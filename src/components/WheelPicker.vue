...
<template>
  <div class="relative w-full h-24 flex items-center justify-center bg-gray-900/50 rounded-xl overflow-hidden border border-gray-700">
    ...
    >
      <div 
        ...
        class="w-20 shrink-0 flex flex-col items-center justify-center snap-center transition-all duration-300"
